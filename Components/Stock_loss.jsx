...
export const Stock_loss = ({ props }) => {

  return (
    <div className='h-400 white text-black pt-10 drop-shadow-2xl'>
      <div className='text-2xl font-medium pl-20 text-white'>Losses of the Day</div>
            ...
            { 
              return(
                <div key={props.key} className='flex space-x-5'>
                  ...
                  <div className='flex-1 px-3 font-semibold'>
                    {values[1]}
                  </div>
                  <div className='flex-1 font-semibold'>
                    ${values[2]}
                  </div>
                  <div className='flex-2 text-red-500 font-semibold'>
                    {values[3]}
                  </div>
                </div>
              )
